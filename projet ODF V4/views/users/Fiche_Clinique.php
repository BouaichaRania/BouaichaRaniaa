    ...
    <li class="table-header">
        ...
        <li class="table-row">
          ...
          <div class="col col-2" data-label="Options">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="circonscrite_rep" id="circonscrite_rep" value="circonscrite">
                <label class="form-check-label" for="circonscrite_rep">circonscrite</label>
                </div>
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="anterieure_rep" id="anterieure_rep" value="Interposition  anterieure ">
                <label class="form-check-label" for="anterieure_rep">Interposition  anterieure </label>
                </div>
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="laterale_rep" id="laterale_rep" value="laterale  ">
                <label class="form-check-label" for="laterale_rep">laterale </label>
                </div>
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="totale_rep" id="totale_rep " value="totale ">
                <label class="form-check-label" for="totale_rep">totale  </label>
                </div>
          </div>
        </li>
        <!-- Posture de la langue au repos -->
        ...
        <li class="table-row">
          <div class="col col-1" data-label="examen de la face">Posture de la langue en fonction</div>
            <div class="col col-2" data-label="Options">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="circonscrite" id="circonscrite" value="circonscrite">
                <label class="form-check-label" for="circonscrite">circonscrite</label>
                </div>
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="anterieure_fct" id="anterieure_fct" value="Interposition  anterieure">
                <label class="form-check-label" for="anterieure_fct">Interposition  anterieure </label>
                </div>
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="laterale_fct" id="laterale_fct" value="laterale">
                <label class="form-check-label" for="laterale_fct">laterale  </label>
                </div>
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="totale_fct" id="totale_fct" value="totale">
                <label class="form-check-label" for="totale_fct">totale  </label>
                </div>
        ...
        <!-- Posture de la langue en fonction -->
           ...
           <li class="table-row">
                ...
                <div class="col col-2" data-label="Options">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="anomaliep" id="anomaliep" value="anomalie">
                        <label class="form-check-label" for="anomaliep">anomalie </label>
                    </div>
                    <div class="form-check form-check-inline">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="anomaliec" id="anomaliec" value="anomalie">
                        <label class="form-check-label" for="anomaliec">anomalie  </label>
                    </div>
                    <div class="form-check form-check-inline">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="anomalief" id="anomalief" value="anomalie">
                        <label class="form-check-label" for="anomalief">anomalie</label>
                    </div>
    ...
    <li class="table-header">
            ...
            <li class="table-row">
              ...
              <div class="col col-2" data-label="Options">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="normalb" id="normalb" value="OB-normal ">
                    <label class="form-check-label" for="normalb">OB-normal </label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="Augmentéb" id="Augmentéb" value="OB-Augmenté ">
                    <label class="form-check-label" for="Augmentéb ">OB-Augmenté</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="Diminuéb" id="Diminuéb " value="OB-Diminué ">
                    <label class="form-check-label" for="Diminuéb">OB-Diminué </label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="normalj" id="normalj" value="OJ-normal">
                    <label class="form-check-label" for="normalj">OJ-normal</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="Augmentéj" id="Augmentéj" value="OJ-Augmenté">
                    <label class="form-check-label" for="Augmentéj">OJ-Augmenté</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="Diminuéj" id="Diminuéj" value="OJ-Diminué  ">
                    <label class="form-check-label" for="Diminuéj">OJ-Diminué  </label>
                    </div>
              </div>
            </li>
            <!-- Rapport du sens vertical -->
